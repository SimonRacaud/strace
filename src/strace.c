...
const struct s_syscall g_syscalls[] = {
        ...
        .args =
            {
                ...
                {.custom = false, .printer = {.type = T_SIZE_T}},
            }},
    {.id = 1,
        .name = "write",
        .noreturn = false,
        ...
        .args =
            {
                {.custom = false, .printer = {.type = T_STRING}},
                {.custom = false, .printer = {.type = T_INTEGER}},
                {.custom = false, .printer = {.type = T_DEFAULT}}, // FLAG
            }},
    {.id = 3,
        .name = "close",
        .noreturn = false,
    ...
    {.id = 7,
        ...
        .args =
            {
                {.custom = false, .printer = {.type = T_POINTER}}, // struct
                {.custom = false, .printer = {.type = T_DEFAULT}}, // struct
                {.custom = false, .printer = {.type = T_INTEGER}},
            }},
    {.id = 8,
        .name = "lseek",
    ...
    {.id = 9,
        ...
        .args =
            {
                {.custom = false, .printer = {.type = T_POINTER}},
                {.custom = false, .printer = {.type = T_SIZE_T}},
                {.custom = false, .printer = {.type = T_INTEGER}},
                {.custom = false, .printer = {.type = T_INTEGER}},
                {.custom = false, .printer = {.type = T_INTEGER}},
    ...
    {.id = 16,
        ...
        .args =
            {
                {.custom = false, .printer = {.type = T_INTEGER}},
                {.custom = false, .printer = {.type = T_ULONG}},
                {.custom = false, .printer = {.type = T_DEFAULT}},
            }},
    {.id = 17,
        .name = "pread64",
    ...
    {.id = 158,
        ...
        .retval = T_INTEGER,
        .argc = 2,
        .args = {{.custom = false, .printer = {.type = T_INTEGER}},
            {.custom = false, .printer = {.type = T_DEFAULT}}}},
    {.id = 159,
        .name = "adjtimex",
        .noreturn = false,
    ...
    {.id = 231,
        ...
        .retval = T_DEFAULT,
        .argc = 1,
        .args = {{.custom = false, .printer = {.type = T_DEFAULT}}}},
    {.id = 232,
        .name = "epoll_wait",
        .noreturn = false,
        .retval = T_DEFAULT,
        ...
        .args =
            {
                ...
                {.custom = false, .printer = {.type = T_STRING}},
                {.custom = false, .printer = {.type = T_INTEGER}},
                {.custom = false, .printer = {.type = T_DEFAULT}}, // mode_t
            }},
    {.id = 258,
        .name = "mkdirat",
        .noreturn = false,
